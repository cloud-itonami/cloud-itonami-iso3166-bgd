(ns marketentry.store
  "SSoT for the BGD market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems BD" :portal "e-GP/CPTU"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-bd-entity? true :has-bd-entity? true
             :requires-tin? true :tin-verified? true
             :drafted? false :submitted? false
             :jurisdiction "BGD" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "e-GP/CPTU"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-bd-entity? true :has-bd-entity? true
             :requires-tin? true :tin-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "e-GP/CPTU"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "BGD" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "e-GP/CPTU"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-bd-entity? true :has-bd-entity? false
             :requires-tin? true :tin-verified? true
             :drafted? false :submitted? false
             :jurisdiction "BGD" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "e-GP/CPTU"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-bd-entity? true :has-bd-entity? true
             ...
             :drafted? false :submitted? false
             :jurisdiction "BGD" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "e-GP/CPTU"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               requires-bd-entity? has-bd-entity?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-bd-entity?)  (assoc :engagement/requires-bd-entity? requires-bd-entity?)
    (some? has-bd-entity?)       (assoc :engagement/has-bd-entity? has-bd-entity?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-bd-entity? :engagement/has-bd-entity?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-bd-entity? (boolean (:engagement/requires-bd-entity? m))
     :has-bd-entity? (boolean (:engagement/has-bd-entity? m))
...
(defn kotobase-store
  ...
  [{:keys [db-api seq-fn]}]
  (->KotobaseStore (persist/store {:db-api db-api :actor "marketentry-bgd"})
