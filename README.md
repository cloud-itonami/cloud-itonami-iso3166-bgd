...
Open ISO 3166 Blueprint for **BGD**: Bangladesh.
...
tax registration, and local-content rules in Bangladesh, so the operator
...
- **Not the government of Bangladesh.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to Bangladeshi-licensed counsel
...
(ISO 3166 `BGD`). Required capabilities:
